...
class Model_:
    ...
    def build_model(self, dataset, nb_classes = 2):
        ...
        #op = Dense(1024, activation='relu')(base_model.output)
        #op = Dense(512, activation='relu')(base_model.output)
        #op = Dropout(.05)(op)
    #
    ...
    MODEL_PATH = './model/regularizer.model.h5'
...
if __name__ == '__main__':
    ...
    model.train(dataset)
    model.save_model(file_path = './model/regularizer.model.h5')#儲存model
    #評估模型
    model = Model_()
    model.load_model(file_path = './model/regularizer.model.h5')
